#!/usr/bin/env bash
# Builds Jetty.app from the command line and reveals it in Finder on success.
...
set -euo pipefail
export BUILD_APP_NAME="Jetty"
export BUILD_KIND="xcode"
export BUILD_XCODE_PROJECT="Jetty.xcodeproj"
export BUILD_XCODE_SCHEME="Jetty"
